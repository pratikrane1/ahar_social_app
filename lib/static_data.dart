...
class Data {
  ...
  List<AlbumList>? albumList = [
    AlbumList(
        albumName: "Media",
        albumImage:
            "https://www.ahar.in/wp-content/uploads/2022/11/ab210413-b1c7-4bf1-8893-1eb869edb154.jpg",
        albumLength: "4",
        albumImages: [
          AlbumImages(
            likeCount: 0,
            albumImages:
                "https://www.ahar.in/wp-content/uploads/2022/11/f7491141-7aee-43b7-8c02-c89dd2c7b301.jpg",
          ),
          AlbumImages(
            likeCount: 0,
            albumImages:
          ...
          AlbumImages(
            likeCount: 0,
            albumImages:
                "https://www.ahar.in/wp-content/uploads/2022/11/2ac6bc3b-cb26-4a3c-b781-d16f7998c17c.jpg",
          ),
          AlbumImages(
            likeCount: 0,
            albumImages:
          ...
          AlbumImages(
            likeCount: 0,
            albumImages:
                "https://www.ahar.in/wp-content/uploads/2022/11/7c9bb304-0542-4553-8b43-ceac12ea3830.jpg",
          ),
          AlbumImages(
            likeCount: 0,
            albumImages:
                "https://www.ahar.in/wp-content/uploads/2022/11/Mid-day-3rdapril2021.jpg",
          ),
          AlbumImages(
            likeCount: 0,
            albumImages:
                "https://www.ahar.in/wp-content/uploads/2022/11/9ecce92c-81af-4e13-bc15-a2cbd2acabdf.jpg",
          ),
        ])
  ];
  ...
  //   FeedModel(
  //     userName: "sukeshshetty",
  //     likeCount: '1',
  //     postImage:
  //         "https://www.ahar.in/wp-content/uploads/2022/11/f7491141-7aee-43b7-8c02-c89dd2c7b301.jpg",
  //     postText: "",
  //     zoneName: 'Mumbai Zone 1',
  //     userImage: 'https://cdn-icons-png.flaticon.com/512/3135/3135715.png',
  //   ),
  //   FeedModel(
  //       userName: "pramodkamath",
  //       likeCount: '1',
  //       postImage:
  //           "https://www.ahar.in/wp-content/uploads/2022/11/2ac6bc3b-cb26-4a3c-b781-d16f7998c17c.jpg",
  //       postText: "",
  //       zoneName: 'Mumbai Zone 2',
  //       userImage:
  ...
  List<NoticeBoardModel>? noticeBoardList = [
    NoticeBoardModel(
      ...
      userImage:
          'https://www.pngall.com/wp-content/uploads/5/Profile-Male-PNG.png',
      pdfText: 'GuideLines CBIC - Filing / Revising of TRAN-1',
    ),
    NoticeBoardModel(
        userName: "pramodkamath",
        postText:
