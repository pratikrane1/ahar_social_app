...
import 'package:aharconnect/widget/image_picker_widget.dart';
...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  final _cityController = TextEditingController();  final _businessNameController = TextEditingController();
    ...
    return Scaffold(
        ...
        body: GetBuilder<MyProfileController>(builder: (myAccountController) {
          ...
          if (_profileData != null) {
            ...
            return _profileData != null ? SingleChildScrollView(
              child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(fontSize: 15,color: _addressController.text == "" ?Colors.red: null),
                              enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: ThemeColors.blackColor.withOpacity(0.2)),
                              ),
                              focusedBorder: UnderlineInputBorder(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(fontSize: 15,color: _messageController.text == "" ?Colors.red: null),
                              enabledBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: ThemeColors.blackColor.withOpacity(0.2)),
                              ),
                              focusedBorder: UnderlineInputBorder(
