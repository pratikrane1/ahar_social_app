                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${'Starting From'} ${_membershipDetails!.createdAt} ${'Till'} ${_membershipDetails!.endAt}',
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  '\u{20B9} ${_membershipDetails!.membershipDetails!.amount}',
                                  style: GoogleFonts.openSans(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w600,
                                  ...
                                  onPressed: () async {
                                    showDialog(
                                        ...
                                        builder: (BuildContext context) =>
                                            PaymentDialog(
                                              amount: _membershipDetails!.membershipDetails!.amount.toString(),
                                              paidAmount: _membershipDetails!.membershipDetails!.amount.toString(),
                                            ));
                                  },
                                  height: 50,
