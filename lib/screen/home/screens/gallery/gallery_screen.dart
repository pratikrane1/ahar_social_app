...
import 'package:aharconnect/screen/home/screens/gallery/Image/images_screen.dart';
import 'package:aharconnect/widget/album_shimmer.dart';
      ...
      body: Column(
        children: [
          ...
          _isImage
            ...
            return _isAlbumLoading ? _albumList!.isNotEmpty ? Expanded(
                child:
                Padding(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Center(
                                          child: Row(
                                            ...
                                            children: [
                                              Flexible(
                                                child: Text(_albumList![index].name ?? "",
