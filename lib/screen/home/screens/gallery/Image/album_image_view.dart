...
//       : super(key: key);
//
//   List<AlbumImagesModel> albumImage;
...
//     currentImageUrl = widget.albumImage[widget.initialIndex].photoUrl ?? "";
...
//                         imageUrl: widget.albumImage[index].photoUrl.toString(),
...
//                         }
//                       },
//                       child: Icon(widget.albumImage[currentIndex!].isLike != "1" ? CupertinoIcons.heart : CupertinoIcons.heart_fill,
//                           color:widget.albumImage[currentIndex!].isLike == "1" ? ThemeColors.redColor : ThemeColors.whiteColor,
//                           size: 25)),
...
//                   Text("(${widget.albumImage[currentIndex!].totalShare ?? 0})",
//                     style:const TextStyle(
//                         fontSize: 16,
//                         color: ThemeColors.whiteColor,
//                         fontFamily: 'Montserrat',
